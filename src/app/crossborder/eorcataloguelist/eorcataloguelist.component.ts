...
@Component({
  selector: 'app-eorcataloguelist',
  templateUrl: './eorcataloguelist.component.html',
  styleUrls: ['./eorcataloguelist.component.css']
})
export class EorcataloguelistComponent implements OnInit {
  ...
  onLoad(SearchBy: string, Search: string, ) {
    ...
    return this._catalogueService.EORSearch(SearchBy, Search, startdate, enddate).subscribe(

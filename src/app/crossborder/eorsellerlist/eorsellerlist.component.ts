...
@Component({
  selector: 'app-eorsellerlist',
  templateUrl: './eorsellerlist.component.html',
  styleUrls: ['./eorsellerlist.component.css']
})
export class EorsellerlistComponent implements OnInit {

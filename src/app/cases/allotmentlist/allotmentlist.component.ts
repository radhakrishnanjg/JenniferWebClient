...
import { RTVCaseHeader, RTVCaseImage } from '../../_services/model';
...
export class AllotmentlistComponent implements OnInit {
  ...
  onLoad(SearchBy: string, Search: string, ) {
    ...
    return this._rtvcasesService.RTVAssignSearch(SearchBy, Search, FromDate.toString(), ToDate.toString()).subscribe(
      (lst) => {
        if (lst != null) {
          this.items = lst;
          this.loadItems();

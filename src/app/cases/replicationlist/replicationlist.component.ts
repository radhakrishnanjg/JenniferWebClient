...
@Component({
  selector: 'app-replicationlist',
  templateUrl: './replicationlist.component.html',
  styleUrls: ['./replicationlist.component.css']
})
export class ReplicationlistComponent implements OnInit {
  ...
  onLoad(SearchBy: string, Search: string, ) {
    ...
    return this._rtvcasesService.RTVCaseReplicationSearch(SearchBy, Search, FromDate.toString(), ToDate.toString()).subscribe(
      (lst) => {
        if (lst != null) {
          this.items = lst;
          this.loadItems();

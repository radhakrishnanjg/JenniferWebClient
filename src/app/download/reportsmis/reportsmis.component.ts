...
@Component({
  selector: 'app-reportsmis',
  templateUrl: './reportsmis.component.html',
  styleUrls: ['./reportsmis.component.css']
})
export class ReportsmisComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //
    this._DownloadService.getDownloadScreens('MIS')
      .subscribe(
        (data: DownloadMaster[]) => {
  ...
  Downloadexcel(): void {
    ...
    if (this._authorizationGuard.CheckAcess("Reportsmis", "ViewEdit")) {
      return;
    }

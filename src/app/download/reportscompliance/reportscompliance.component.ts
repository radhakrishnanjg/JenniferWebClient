...
@Component({
  ...
  styleUrls: ['./reportscompliance.component.css']
})
export class ReportscomplianceComponent implements OnInit {
  ...
  Downloadexcel(buttonType): void {
    ...
    if (this._authorizationGuard.CheckAcess("Reportscompliance", "ViewEdit")) {
      return;
    }
